...
const productOverrides: Record<string, Partial<ProductCopy>> = {
  ...
  "mens-summer-set": {
    ...
    included: ["Boxy-Fit Top", "Matching Shorts"],
    singleSize: {
      label: "One Size",
    ...
    benefits: [
      ...
      "Clean minimal design in Black and Dark Gray",
      "Wears great as a full set or as separates",
      "Soft, pre-washed feel from day one",
      "Reinforced stitching that holds up wash after wash",
    ],
    detailedSpecs: [
      { label: "Fit", value: "Boxy Relaxed · Drop-shoulder" },
      { label: "Material", value: "Lightweight Summer Cotton Blend" },
      { label: "Fabric Weight", value: "Lightweight (summer weight)" },
      { label: "Included Pieces", value: "Top + Matching Shorts" },
      { label: "Colors", value: "Black · Dark Gray" },
  ...
  "black-polo-summer-cotton-set": {
    ...
    description:
      "A two-piece summer set for women, made from premium lightweight cotton. Includes a matching zip hoodie and wide-leg pants, designed for a relaxed oversized fit. Breathable and soft against the skin, it works as an everyday outfit or as separates. Women's one-size fit, made in Egypt.",
    ...
    modelInfo: { height: "167 CM", weight: "75 KG", wearing: "One Size" },
    benefits: [
      "Premium breathable summer cotton",
      "Relaxed oversized silhouette",
      "Lightweight for everyday summer wear",
