  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-lg bg-card border-border max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-body font-semibold text-xl text-foreground">Size Guide</DialogTitle>
        </DialogHeader>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-foreground text-background">
                <th className="font-body font-semibold text-xs tracking-wider py-3 px-3 text-left">Size</th>
                <th className="font-body font-semibold text-xs tracking-wider py-3 px-3 text-center">Chest</th>
                <th className="font-body font-semibold text-xs tracking-wider py-3 px-3 text-center">Length</th>
                <th className="font-body font-semibold text-xs tracking-wider py-3 px-3 text-center">Shoulder</th>
                <th className="font-body font-semibold text-xs tracking-wider py-3 px-3 text-center">Sleeve</th>
              </tr>
            </thead>
            <tbody>
              {measurements.map((row, i) => (
                ...
                >
                  <td className="font-body font-semibold text-xs py-3 px-3 text-primary">{row.size}</td>
        ...
        <div className="mt-6 space-y-3">
          <h3 className="font-body font-semibold text-sm tracking-wider text-foreground">Fit Recommendations</h3>
          {fitTips.map((tip) => (
            <div key={tip.label} className="flex gap-3 p-3 bg-background rounded-lg border border-border">
              <div className="w-2 h-2 rounded-full bg-primary mt-1.5 flex-shrink-0" />
              <div>
                <p className="font-body font-semibold text-xs text-foreground">{tip.label}</p>
        ...
        <div className="mt-6 p-4 bg-primary/5 rounded-xl border border-primary/10">
          <h3 className="font-body font-semibold text-sm tracking-wider text-foreground mb-2">How to Measure</h3>
