...
export const HeroSection = () => {
  return (
    <section className="relative min-h-[88vh] md:min-h-screen flex items-center overflow-hidden bg-foreground">
      <picture>
      ...
      <div className="relative container z-10">
        <div className="max-w-2xl pt-16 md:pt-24">
          ...
          <p className="hidden sm:block font-body text-sm md:text-lg text-primary-foreground/70 max-w-md mb-6 md:mb-8">
            Comfort that keeps up with your life. Oversized fits, heavyweight cotton, zero compromise.
          </p>

          <div className="flex flex-row gap-2.5 md:gap-4 mt-4 sm:mt-0">
            <Link
              to="/shop"
              className="group inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground font-heading text-sm md:text-lg tracking-wider uppercase px-5 md:px-8 py-3.5 md:py-4 rounded-lg hover:bg-primary/90 transition-all duration-300 shadow-lg shadow-primary/25"
            >
              Shop New Arrivals
            ...
            <Link
              to="/#featured"
              className="inline-flex items-center justify-center gap-2 border border-primary-foreground/40 bg-primary-foreground/5 text-primary-foreground font-heading text-sm md:text-lg tracking-wider uppercase px-5 md:px-8 py-3.5 md:py-4 rounded-lg hover:border-primary-foreground hover:bg-primary-foreground/10 transition-all duration-300 backdrop-blur-sm"
            >
              Best Sellers
            </Link>
          </div>
