...
const trustItems = [
  {
    ...
    desc: "Every piece undergoes rigorous quality testing before it reaches you.",
  },
  {
    icon: Award,
    title: "Premium Materials",
    desc: "Heavy-weight cotton blends engineered for comfort and durability.",
  },
  {
    icon: Leaf,
    title: "Ethically Made",
    desc: "Fair labor practices and sustainable manufacturing processes.",
  },
  {
    icon: Lock,
    title: "Secure Checkout",
    desc: "Your payment data is protected with industry-standard encryption.",
  },
];
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {trustItems.map((item, i) => (
            <div
              key={item.title}
              className="animate-on-scroll group text-center p-6 bg-card border border-border hover:border-primary/40 transition-all duration-500"
