  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="pb-12 bg-foreground text-background" style={{ paddingTop: 'calc(96px + var(--banner-offset))' }}>
      <div className="container py-8">
        ...
        <h1 className="font-display text-4xl md:text-5xl text-background">Returns & Exchanges</h1>
      </div>
    </section>
      ...
      <div className="container max-w-3xl space-y-8">
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="font-body font-semibold text-lg text-foreground">Changed your mind? No stress.</h2>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-card rounded-xl p-5 border border-border">
            ...
            <h3 className="font-body font-semibold text-sm text-foreground mb-2">We'll take it back if…</h3>
          ...
          <div className="bg-card rounded-xl p-5 border border-border">
            ...
            <h3 className="font-body font-semibold text-sm text-foreground mb-2">We can't accept it if…</h3>
            <ul className="font-body text-sm text-muted-foreground space-y-1.5">
        ...
        <div className="bg-card rounded-xl p-6 border border-border">
          <h2 className="font-body font-semibold text-lg text-foreground mb-4">Here's how it works</h2>
          <ol className="font-body text-sm text-muted-foreground space-y-4 leading-relaxed">
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary font-body font-semibold text-xs flex items-center justify-center">1</span>
              <span>Send us a message on WhatsApp or email with your order number — tell us what's up.</span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary font-body font-semibold text-xs flex items-center justify-center">2</span>
              <span>We'll sort it out and give you return or exchange instructions right away.</span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary font-body font-semibold text-xs flex items-center justify-center">3</span>
              <span>Ship it back in its original packaging — we'll handle the rest.</span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary font-body font-semibold text-xs flex items-center justify-center">4</span>
        ...
        {/* Contact block */}
        <div className="bg-card rounded-xl p-6 border border-border">
          <h2 className="font-body font-semibold text-lg text-foreground mb-2">Need to start a return?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#25D366]/10 text-[#25D366] font-body font-semibold text-sm hover:bg-[#25D366]/20 transition-colors border border-[#25D366]/20"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-primary/10 text-primary font-body font-semibold text-sm hover:bg-primary/20 transition-colors border border-primary/20"
            >
