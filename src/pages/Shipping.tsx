  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="pb-12 bg-foreground text-background" style={{ paddingTop: 'calc(96px + var(--banner-offset))' }}>
      <div className="container py-8">
        ...
        <h1 className="font-display text-4xl md:text-5xl text-background">Shipping Info</h1>
      </div>
    </section>
    <section className="py-12">
      <div className="container max-w-3xl space-y-8">
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-6">
          <h2 className="font-body font-semibold text-lg text-foreground mb-2">The short version?</h2>
        ...
        <div className="bg-card rounded-xl p-6 border border-border">
          <h2 className="font-body font-semibold text-lg text-foreground mb-4">Here's what happens after you order</h2>
        ...
        {/* Contact */}
        <div className="bg-card rounded-xl p-6 border border-border">
          <h2 className="font-body font-semibold text-lg text-foreground mb-2">Got a question about your order?</h2>
