  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="pb-12 bg-foreground text-background" style={{ paddingTop: 'calc(96px + var(--banner-offset))' }}>
      <div className="container py-8">
        ...
        <h1 className="font-display text-4xl md:text-5xl text-background">Terms of Service</h1>
      </div>
    </section>
      ...
      <div className="container max-w-3xl space-y-8">
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="font-body font-semibold text-lg text-foreground">The basics, no lawyer-speak.</h2>
          </div>
        ...
        <div className="bg-card rounded-xl p-6 md:p-8 border border-border font-body text-sm text-muted-foreground space-y-6 leading-relaxed">
          <div>
            <h2 className="font-body font-semibold text-base text-foreground mb-2">Shopping with us</h2>
          ...
          <div>
            <h2 className="font-body font-semibold text-base text-foreground mb-2">Prices & products</h2>
          ...
          <div>
            <h2 className="font-body font-semibold text-base text-foreground mb-2">Orders & payments</h2>
          ...
          <div>
            <h2 className="font-body font-semibold text-base text-foreground mb-2">Shipping</h2>
            <p>
          ...
          <div>
            <h2 className="font-body font-semibold text-base text-foreground mb-2">Returns</h2>
            <p>
          ...
          <div>
            <h2 className="font-body font-semibold text-base text-foreground mb-2">Our stuff is ours</h2>
        ...
        <div className="bg-card rounded-xl p-6 border border-border">
          <h2 className="font-body font-semibold text-lg text-foreground mb-2">Something unclear?</h2>
