    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-8 md:py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-12">
          ...
          >
            <div>
              <h1 className="font-heading text-display-sm text-foreground mb-1 font-bold">{product.title}</h1>
              <p className="font-heading text-title-lg text-primary font-medium tracking-wide">
