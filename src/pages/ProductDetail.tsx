    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 md:items-start">
          ...
          <div>
            {/* 1. TITLE */}
            <h1 className="font-display text-2xl md:text-4xl text-foreground leading-tight">
              {product.title}
            </h1>
            ...
            <div className="flex items-center gap-3 flex-wrap mt-4">
              ...
              {onSale && (
                <>
                  <span className="font-body font-semibold text-lg text-muted-foreground line-through">
                    {compareAt.currencyCode} {parseFloat(compareAt.amount).toFixed(2)}
                  </span>
                  <span className="font-body font-semibold text-xs tracking-wider text-primary-foreground bg-primary px-2.5 py-1 rounded-full">
            ...
            <Button
              ...
              size="lg"
              className="w-full mt-4 bg-primary text-primary-foreground font-body font-semibold text-base tracking-wider uppercase h-14 rounded-xl hover:bg-primary/90 disabled:opacity-60"
            >
        ...
        >
          <div className="container flex items-center gap-3 py-2.5">
            <div className="flex-1 min-w-0">
              <p className="font-body font-semibold text-xs text-foreground truncate">{product.title}</p>
            ...
            <Button
              onClick={handleAddToCart}
              disabled={ctaDisabled}
              className="bg-primary text-primary-foreground font-body font-semibold text-xs tracking-wider uppercase px-6 h-12 rounded-xl hover:bg-primary/90 flex-shrink-0"
            >
